    ...
    public function attemptLogin()
    {
        ...
        if (!$this->auth->attempt([$type => $login, 'password' => $password], $remember)) {
            ...
            if ($attempts >= 2) {
                ...
                // Pesan muncul dulu di login, lalu redirect ke forgot
                session()->setFlashdata('error', 'Akun terkunci sementara. Silakan pulihkan password untuk keamanan.');
                return redirect()->to(url_to('forgot'));
            }


            return redirect()->back()->with('error', 'Login salah. Coba lagi.');
        }
